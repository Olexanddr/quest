...
<html>
	...
	<body>
		...
		<form action = "/conferences/edit/save" method="post" class = "create-form">
			...
			<input type = "text" name="title" value = "<?php echo $pageData["title"] ?>" minlength="2" maxlength = "255" required="required"><br>
			...
			<label>Широта:</label><input type = "text" name = "latitude" id = "lat-span" onchange = "setCoord()" value = "<?php echo $pageData["latitude"] ?>" required="required"><br>
			<label>Долгота:</label><input type = "text" name = "longitude" id = "lng-span" onchange = "setCoord()" value = "<?php echo $pageData["longitude"] ?>" required="required"><br>
