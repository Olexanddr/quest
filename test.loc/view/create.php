...
<html>
	...
	<body>
		...
		<form action = "/conferences/create/save" method = "post" class = "create-form">
			...
			<label>Широта:</label><input type = "text" name = "latitude" id = "lat-span" onchange = "setCoord()" required="required"><br>
			<label>Долгота:</label><input type = "text" name = "longitude" id = "lng-span" onchange = "setCoord()" required="required"><br>
